...
**[→ Enroll in Tier 2: Become an Agentic Architect](https://maven.com/carmelo-iaria/mastering-mas-crewai?utm_source=github&utm_medium=learn-aamad-repo&utm_campaign=tier2-course)**
...
1. **Review Your Mini-Project**
   - Revisit your `LESSONS.md` document
...
- Explore the [AAMAD Framework Repository](https://github.com/synaptic-ai-consulting/AAMAD) in depth
- Build additional projects using AAMAD
- Contribute to the AAMAD community
- Read [The Agentic Architect Playbook](https://maven.com/p/c2fee4/the-agentic-architect-playbook?utm_source=github&utm_medium=learn-aamad-repo&utm_campaign=playbook)
...
- **[Apply for Tier 2](https://maven.com/carmelo-iaria/mastering-mas-crewai?utm_source=github&utm_medium=learn-aamad-repo&utm_campaign=tier2-course)** for full transformation
...
- [ ] Orchestrating AI agents (1 = Beginner, 5 = Expert)
- [ ] Context engineering (1 = Beginner, 5 = Expert)
- [ ] Systems thinking (1 = Beginner, 5 = Expert)
- [ ] Technical leadership (1 = Beginner, 5 = Expert)
- [ ] Business alignment (1 = Beginner, 5 = Expert)
...
**Where are you now?**
- [ ] Still operating "below the algorithm" (following patterns)
- [ ] Transitioning to "above the algorithm" (designing coordination)
- [ ] Operating "above the algorithm" (orchestrating systems)
...
- **[AAMAD Framework Repository](https://github.com/synaptic-ai-consulting/AAMAD)** - Framework documentation and examples
- **[The Agentic Architect Playbook](https://maven.com/p/c2fee4/the-agentic-architect-playbook?utm_source=github&utm_medium=learn-aamad-repo&utm_campaign=playbook)** - Deep dive into the Agentic Architect role
- **[CrewAI Documentation](https://docs.crewai.com/)** - CrewAI framework guide
- **[CrewAI Examples](https://github.com/crewAIInc/crewAI-examples)** - Reference implementations

### Learning Resources

- **Tier 1 (2-week cohort)** - Coming Soon
- **[Tier 2 (6-week project)](https://maven.com/carmelo-iaria/mastering-mas-crewai?utm_source=github&utm_medium=learn-aamad-repo&utm_campaign=tier2-course)** - Enroll now
...
- **[Tier 2 (6-week project)](https://maven.com/carmelo-iaria/mastering-mas-crewai?utm_source=github&utm_medium=learn-aamad-repo&utm_campaign=tier2-course)** – Enroll now and build your production-ready capstone project
